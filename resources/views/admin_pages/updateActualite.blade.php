...
<div class="max-w-5xl mx-auto my-14">
    <div class="flex flex-col justify-between items-center">
        ...
        <form class="max-w-md mx-auto" style="width:500px;" method="post"
            action="{{route('updateConfirmActualite', $actualite->id)}}">
            @csrf
            ...
            <input
                ...
                placeholder="{{$actualite->photo}}" required>
            ...
            <textarea id="contenu" name="contenu" rows="8"
                ...
                placeholder="{{$actualite->contenu}}" required></textarea>
        ...
        <div>
            ...
            <a type="button" href="{{route('dashboard_actualite')}}"
