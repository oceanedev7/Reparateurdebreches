...
@section('title', 'Dashboard-Gérer les évènements-Mise à jour')
...
<div class="max-w-5xl mx-auto my-14">
    <div class="flex flex-col justify-between items-center">
        ...
        <form class="max-w-md mx-auto" style="width:500px;" method="post"
            action="{{route('updateConfirmEvenement', $evenement->id)}}">
            @csrf
            ...
            <input
                ...
                placeholder="{{$evenement->photo}}" required>
        ...
        <div>
            ...
            <a type="button" href="{{route('dashboard_evenement')}}"
