...
<body>
    ...
    <nav class="">
        ...
        <div class="flex items-center justify-between h-32	">
            ...
            <a  href="" class="text-blue-700 font-black space-x-48 text-xl font-sans flex justify-between"> ARTICLES</a>
            <a href="{{ route('contact') }}" class="text-blue-700 font-black space-x-48 text-xl font-sans flex justify-between"> NOUS CONTACTER</a>
            ...
            <div class="mt-5 flex lg:ml-4 lg:mt-0 mr-12">
              ...
              <button class="ml-3 hidden sm:block">
                <a href="{{route('deveniradherent')}}" class="bg-blue-700 text-white py-2 px-4 text-center rounded text-lg font-bold"> DEVENIR ADHERENT</a>
              </button>
