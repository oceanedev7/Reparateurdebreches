        ...
        {{-- <div class="flex items-center justify-between h-24">
            ...
            <div class="h-44 w-48 ml-12 py-10 z-10 ">
                <img class="h-44 w-48 rounded shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]"
                    src="{{ Storage::url('images/logo1.png') }}" alt="">
            </div>

            <a href="" class="text-bleu-fonce font-black space-x-48 text-xl font-sans flex justify-between"> ACCUEIL
            </a>
            <a href="" class="text-bleu-fonce font-black space-x-48 text-xl font-sans flex justify-between">
                ARTICLES</a>
            <a href="" class="text-bleu-fonce font-black space-x-48 text-xl font-sans flex justify-between"> NOUS
                CONTACTER</a>

            <div class="mt-5 flex lg:ml-4 lg:mt-0 mr-12">

                <span class="hidden sm:block">
                    <a href="" class="bg-bleu-fonce text-white py-2 ps-4 pe-4 rounded text-lg "><i
                            class="fa-solid fa-user"></i> </a>
                </span>

                <button class="ml-3 hidden sm:block">
                    <a href="" class="bg-bleu-fonce text-white py-2 px-4 text-center rounded text-lg font-bold"> DEVENIR
                        ADHERENT</a>
                </button>
        ...
        <header class="">
            ...
            <div class="relative items-center mb-10 flex flex-row">
                ...
                <div class="mt-5 flex lg:ml-4 lg:mt-0 mr-12">
                    ...
                    <button class="ml-3 hidden sm:block">
                        <a href="" class="bg-bleu-fonce text-white py-2 px-4 text-center rounded text-lg font-bold">
                            DEVENIR ADHERENT</a>
                    </button>

                    <button class="sm:ml-3  hidden sm:block">
                        <a href=""
                            class="bg-bleu text-bleu-fonce py-2 px-4 text-center  rounded text-lg font-bold">FAIRE UN
                            DON </a>
                    </button>
                ...
                -->
                        ...
                        <div class=" flex lg:ml-4 lg:mt-0 mr-12">

                            <span class="hidden sm:block">
                                <a href="{{ route('login') }}"
                                    class="bg-bleu-fonce text-white py-2 ps-4 pe-4 rounded text-lg "><i
                                        class="fa-solid fa-user"></i> </a>
                            </span>

                            <button class="ml-3 hidden sm:block">
                                <a href="{{route('deveniradherent')}}"
                                    class="bg-bleu-fonce text-white py-2 px-4 text-center rounded text-lg font-bold">
                                    DEVENIR ADHERENT</a>
                            </button>

                            <button class="sm:ml-3  hidden sm:block">
                                <a href=""
                                    class="bg-bleu text-bleu-fonce py-2 px-4 text-center  rounded text-lg font-bold">FAIRE
                                    UN DON </a>
                            </button>
